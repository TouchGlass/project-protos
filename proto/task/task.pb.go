...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x06userId\x18\x04 \x01(\rR\x06userId\"Y\n" +
	...
	"\n" +
	"DeleteTask\x12\x17.task.DeleteTaskRequest\x1a\x18.task.DeleteTaskResponseB1Z/github.com/TouchGlass/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	6,  // 6: task.TaskService.ListTasksByUser:input_type -> task.ListTasksByUserRequest
	...
	5,  // 12: task.TaskService.ListTasksByUser:output_type -> task.ListTasksResponse
